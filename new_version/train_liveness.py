...
from new_version.pyimagesearch.liveness_res_net import LivenessResNet
...
for imagePath in imagePaths:
    # Extract the class label from the filename, load the image and resize it to be a fixed 32x32 pixels, ignoring aspect ratio
